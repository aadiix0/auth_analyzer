...
public class Session {
	...
	public Session(String name, String headersToReplace, boolean removeHeaders, String headersToRemove, boolean filterRequestsWithSameHeader, boolean restrictToScope, 
			URL scopeUrl, boolean testCors, ArrayList<Token> tokens, ArrayList<MatchAndReplace> matchAndReplaceList, ArrayList<AutoSyncConfig> autoSyncList, StatusPanel statusPanel) {
		this.name = name;
