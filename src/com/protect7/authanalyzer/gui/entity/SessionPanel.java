...
import com.protect7.authanalyzer.gui.dialog.AutoSyncDialog;
...
public class SessionPanel extends JPanel {
	...
	private ArrayList<AutoSyncConfig> autoSyncList = new ArrayList<AutoSyncConfig>();
	private final MainPanel mainPanel;
	private final JButton liveProxySyncButton;
	...
	public SessionPanel(String sessionName, MainPanel mainPanel) {
		...
		liveProxySyncButton = new JButton("Live Proxy Sync");
		liveProxySyncButton.addActionListener(e -> {
			new AutoSyncDialog(this);
		});
		buttonPanel.add(liveProxySyncButton);
	...
	public void setAutoSyncList(ArrayList<AutoSyncConfig> autoSyncList) {
		this.autoSyncList = autoSyncList;
		updateLiveProxySyncButtonText();
	}
	
	public ArrayList<AutoSyncConfig> getAutoSyncList() {
		return autoSyncList;
	}

	public void updateLiveProxySyncButtonText() {
		if(autoSyncList.size() > 0) {
			liveProxySyncButton.setText("Live Proxy Sync (" + autoSyncList.size() + ")");
		} else {
			liveProxySyncButton.setText("Live Proxy Sync");
		}
	}
